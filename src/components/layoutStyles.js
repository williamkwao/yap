...
export const LayoutStyle = styled.div`
  @font-face {
    ...
    src: url('../fonts/trade-gothic/TradeGothicLTStd.otf') format('opentype');
  }
  ...
  pre,
  samp {
    font-family: TradeGothic, monospace, monospace;
    font-size: 1em;
  }
  ...
  *:after {
  ...
  body {
    ...
    font-family: TradeGothic, georgia, serif;
    font-weight: normal;
  ...
  code {
    ...
    border-radius: 3px;
    font-family: TradeGothic, 'SFMono-Regular', Consolas, 'Roboto Mono',
